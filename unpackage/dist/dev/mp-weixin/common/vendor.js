...
const tabBar = {
  ...
  list: [
    ...
    },
    {
      ...
      selectedIconPath: "./static/images/tabbar/menu-fill.png"
    },
    {
...
const d = true, f = "mp-weixin", g = h('{\n    "address": [\n        "127.0.0.1",\n        "192.168.1.104"\n    ],\n    "debugPort": 4082,\n    "initialLaunchType": "local",\n    "servePort": 4083\n}\n'), p = h('[{"provider":"aliyun","spaceName":"losocy","spaceId":"f9c97520-86df-4484-8581-93e357bf6fe6","clientSecret":"GVmc6l6BRVWOtGYZQcQAyw==","endpoint":"https://api.bspapp.com"}]');
let y = "";
try {
  y = "__UNI__B18D014";
} catch (e2) {
